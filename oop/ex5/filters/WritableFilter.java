...
/**
 * The Writable filter checks if a file's writing permissions is the same as the one given.
 * @author Idan Refaeli
 */
public class WritableFilter implements Filter {
	 ...
	 */
	public WritableFilter(String hasPermission) throws WrongFilterFormatException {
